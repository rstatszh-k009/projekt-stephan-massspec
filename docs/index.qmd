...
### Cortison Gehalte über alle Proben
...
### Hydrocortison Gehalte über alle Proben
...
Es wurden nur die Daten von Tieren der Rindergattung und Schweinen ausgewertet, da von den anderen Tierarten nicht alle Matrizes analysiert wurden.
#### Cortison
```{r}
#| eval: true
#| echo: true
